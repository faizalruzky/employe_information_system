...
<html lang="en">
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="<?php echo base_url(); ?>sms_gateway"><i class="icon-envelope icon-white"></i> SMS Gateway</a></li>
            </ul>
  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">SMS Gateway</a>
		  <div class="nav-collapse">
			
  

<ul class="nav">
        <li><a href="<?php echo base_url(); ?>sms_gateway/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Sms</a></li>
      </ul>
      </div>
