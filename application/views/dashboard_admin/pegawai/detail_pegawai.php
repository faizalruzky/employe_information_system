        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="<?php echo base_url(); ?>"><i class="icon-envelope icon-white"></i> SMS Gateway</a></li>
            </ul>
  ...
  <div class="well">
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="control-group">
    	 ...
    	 <div class="control-group">
			<div class="span3"><strong>Nomor Telepon</strong></div>
			<div class="span">:</div>
			<div class="span6">
			  <input type="text" disabled="disabled" class="span6" name="no_tlp" id="no_tlp" value="<?php echo $no_telepon; ?>" placeholder="Nomor Telepon">
			</div>
		  </div>
