...
<section id="data-pegawai">
  ...
  <div class="navbar navbar-inverse">
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="control-group">
			<label class="control-label" for="no_telepon">Nomor Telepon</label>
			<div class="controls">
			<?php
			if($st=="tambah")
			{
			?>
			  <input type="text" class="span6" name="no_tlp" id="no_tlp" value="<?php echo set_value('no_telepon'); ?>" placeholder="Nomor Telepon">
			<?php
			}
			else
			{
			?>
			  <input type="text" class="span6" name="no_tlp" id="no_tlp" value="<?php echo $no_telepon; ?>" placeholder="Nomor Telepon">
			<?php
			}
			?>
			</div>
