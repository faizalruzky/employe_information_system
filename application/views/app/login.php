  ...
  <body>
	...
	<?php } ?>
      <div class="hero-unit">
        ...
        <p>Sistem Informasi Kepegawaian PNS Cipadung merupakan sebuah aplikasi 
          untuk melakukan manajemen data kepegawaian untuk pegawai negeri sipil (PNS) 
          di Cipadung. Silahkan masukkan username dan password anda untuk mulai untuk melakukan 
          manajemen atau pengolahan data kepegawaian sesuai dengan hak akses yang anda miliki.</p>
