...
class App_Login_Model extends CI_Model {
	...
	*/
	...
	public function getLoginData($data)
	{
		...
		$login['password'] = md5($data['password'].'FaizalRuzky14');
		...
		{
			$this->session->set_flashdata('result_login', "Maaf, kombinasi username dan password 
				yang anda masukkan tidak valid dengan database kami.");
			header('location:'.base_url().'');
		}
	}
}
