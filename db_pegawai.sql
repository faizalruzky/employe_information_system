...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2015 at 07:00 AM
...
(2788, '123', '1234', '-', 'Faizal Ruzky', 'Bekasi', '-', 'Laki-Laki', 'Islam', '21', '7', '-', '-', '-', '-', '-', '3', 10, '-', '-', '-', '-', 3, 2345, 2, 8, '15', '-', '-', '-', '-', 23, '-', '');
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2414 ;
...
(2, 'faizal', '908e1b41c29af181dbfc1b669cc2aad2', 'Faizal Ruzky', 'administrator'),
(3, 'operator', '73e128814b8a91fee07af8fb75780f82', 'Operator', 'operator');
